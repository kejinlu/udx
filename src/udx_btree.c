...
static void *btree_spare_at(const struct udx_btree *btree, size_t index) {
    return (void*)(btree->spare_data+btree->spare_elsize*index);
}

void udx_btree_set_searcher(struct udx_btree *btree,
    int (*searcher)(const void *items, size_t nitems, const void *key,
        bool *found, void *udata))
{
...
static void *btree_get_item_at(struct udx_btree *btree, struct btree_node *node,
    size_t index)
{
    return node->items+btree->elsize*index;
}

static void btree_set_item_at(struct udx_btree *btree, struct btree_node *node,
...
static void btree_swap_item_at(struct udx_btree *btree, struct btree_node *node,
...
static void btree_copy_item_into(struct udx_btree *btree,
    struct btree_node *node, size_t index, void *into)
{
    memcpy(into, btree_get_item_at(btree, node, index), btree->elsize);
}

static void btree_node_shift_right(struct udx_btree *btree, struct btree_node *node,
    size_t index)
{
...
static void btree_node_shift_left(struct udx_btree *btree, struct btree_node *node,
...
static void btree_copy_item(struct udx_btree *btree, struct btree_node *node_a,
...
static void btree_node_join(struct udx_btree *btree, struct btree_node *left,
...
static int _btree_compare(const struct udx_btree *btree, const void *a,
    const void *b)
{
    return btree->compare(a, b, btree->udata);
}

static size_t btree_node_bsearch(const struct udx_btree *btree,
...
static int btree_node_bsearch_hint(const struct udx_btree *btree,
...
static size_t btree_memsize(size_t elsize, size_t *spare_elsize) {
    size_t size = btree_align_size(sizeof(struct udx_btree));
...
struct udx_btree *udx_btree_new_with_allocator(
    void *(*malloc_)(size_t),
    ...
    void *udata)
{
    ...
    struct udx_btree *btree = malloc_(size);
    if (!btree) {
        return NULL;
    }
    memset(btree, 0, size);
...
struct udx_btree *udx_btree_new(size_t elsize, size_t max_items,
    int (*compare)(const void *a, const void *b, void *udata), void *udata)
{
    return udx_btree_new_with_allocator(NULL, NULL, NULL, elsize, max_items,
        compare, udata);
}

static size_t btree_node_size(struct udx_btree *btree, bool leaf,
    size_t *items_offset)
{
...
static struct btree_node *btree_node_new(struct udx_btree *btree, bool leaf) {
    size_t items_offset;
...
static void btree_node_free(struct udx_btree *btree, struct btree_node *node) {
...
static struct btree_node *btree_node_copy(struct udx_btree *btree,
...
void udx_btree_clear(struct udx_btree *btree) {
    if (btree->root) {
...
void udx_btree_free(struct udx_btree *btree) {
    udx_btree_clear(btree);
    btree->free(btree);
}

void udx_btree_set_item_callbacks(struct udx_btree *btree,
...
struct udx_btree *udx_btree_clone(struct udx_btree *btree) {
    if (!btree) {
        return NULL;
    }
    size_t size = btree_memsize(btree->elsize, NULL);
    struct udx_btree *btree2 = btree->malloc(size);
    if (!btree2) {
        return NULL;
    }
...
static size_t btree_search(const struct udx_btree *btree, struct btree_node *node,
...
static void btree_node_split(struct udx_btree *btree, struct btree_node *node,
...
static enum btree_mut_result btree_node_set(struct udx_btree *btree,
...
static void *btree_set0(struct udx_btree *btree, const void *item, uint64_t *hint,
    bool no_item_clone)
{
    btree->oom = false;
...
static const void *btree_get0(const struct udx_btree *btree, const void *key,
    uint64_t *hint)
{
...
static void btree_node_rebalance(struct udx_btree *btree, struct btree_node *node,
    size_t i)
{
    if (i == node->nitems) {
        i--;
...
static enum btree_mut_result btree_node_delete(struct udx_btree *btree,
...
static void *btree_delete0(struct udx_btree *btree, enum btree_delact act,
...
const void *udx_btree_set_hint(struct udx_btree *btree, const void *item,
    uint64_t *hint)
{
    return btree_set0(btree, item, hint, false);
}

const void *udx_btree_set(struct udx_btree *btree, const void *item) {
    return btree_set0(btree, item, NULL, false);
}

const void *udx_btree_get_hint(const struct udx_btree *btree, const void *key,
    uint64_t *hint)
{
    return btree_get0(btree, key, hint);
}

const void *udx_btree_get(const struct udx_btree *btree, const void *key) {
    return btree_get0(btree, key, NULL);
}

void *udx_btree_get_mut(struct udx_btree *btree, const void *key) {
    return (void *)btree_get0(btree, key, NULL);
}

const void *udx_btree_delete_hint(struct udx_btree *btree, const void *key,
    uint64_t *hint)
{
    return btree_delete0(btree, BTREE_DELKEY, 0, key, hint);
}

const void *udx_btree_delete(struct udx_btree *btree, const void *key) {
    return btree_delete0(btree, BTREE_DELKEY, 0, key, NULL);
}

const void *udx_btree_pop_min(struct udx_btree *btree) {
    btree->oom = false;
    if (btree->root) {
        btree_cow_node_or(btree->root, goto oom);
        struct btree_node *node = btree->root;
...
const void *udx_btree_pop_max(struct udx_btree *btree) {
    btree->oom = false;
    if (btree->root) {
        btree_cow_node_or(btree->root, goto oom);
        struct btree_node *node = btree->root;
...
bool udx_btree_oom(const struct udx_btree *btree) {
    return !btree || btree->oom;
}

size_t udx_btree_count(const struct udx_btree *btree) {
    return btree->count;
}

int btree_compare(const struct udx_btree *btree, const void *a, const void *b) {
    return _btree_compare(btree, a, b);
}

static bool btree_node_scan(const struct udx_btree *btree, struct btree_node *node,
...
static bool btree_node_ascend(const struct udx_btree *btree,
    struct btree_node *node,
...
bool udx_btree_ascend_hint(const struct udx_btree *btree, const void *pivot,
...
bool udx_btree_ascend(const struct udx_btree *btree, const void *pivot,
    bool (*iter)(const void *item, void *udata), void *udata)
{
    return udx_btree_ascend_hint(btree, pivot, iter, udata, NULL);
}

static bool btree_node_reverse(const struct udx_btree *btree,
    struct btree_node *node,
    bool (*iter)(const void *item, void *udata), void *udata)
{
    if (node->leaf) {
...
static bool btree_node_descend(const struct udx_btree *btree,
...
bool udx_btree_descend_hint(const struct udx_btree *btree, const void *pivot,
    bool (*iter)(const void *item, void *udata), void *udata, uint64_t *hint)
{
    if (btree->root) {
        if (!pivot) {
...
bool udx_btree_descend(const struct udx_btree *btree, const void *pivot,
    bool (*iter)(const void *item, void *udata), void *udata)
{
    return udx_btree_descend_hint(btree, pivot, iter, udata, NULL);
}

const void *udx_btree_min(const struct udx_btree *btree) {
    struct btree_node *node = btree->root;
    if (!node) {
        return NULL;
    }
...
const void *udx_btree_max(const struct udx_btree *btree) {
    struct btree_node *node = btree->root;
    if (!node) {
        return NULL;
    }
...
const void *udx_btree_load(struct udx_btree *btree, const void *item) {
    btree->oom = false;
    if (!btree->root) {
        return btree_set0(btree, item, NULL, false);
    }
...
size_t udx_btree_height(const struct udx_btree *btree) {
    return btree->height;
}
...
struct udx_btree_iter {
    struct udx_btree *btree;
    void *item;
    bool seeked;
    bool atstart;
    bool atend;
...
struct udx_btree_iter *udx_btree_iter_new(const struct udx_btree *btree) {
    size_t vsize = btree_align_size(sizeof(struct udx_btree_iter) +
        sizeof(struct btree_iter_stack_item) * btree->height);
    struct udx_btree_iter *iter = btree->malloc(vsize + btree->elsize);
    if (iter) {
...
void udx_btree_iter_free(struct udx_btree_iter *iter) {
    iter->btree->free(iter);
}

bool udx_btree_iter_first(struct udx_btree_iter *iter) {
    iter->atend = false;
    iter->atstart = false;
    iter->seeked = false;
    iter->nstack = 0;
...
bool udx_btree_iter_last(struct udx_btree_iter *iter) {
    iter->atend = false;
    iter->atstart = false;
    iter->seeked = false;
    iter->nstack = 0;
...
bool udx_btree_iter_next(struct udx_btree_iter *iter) {
    if (!iter->seeked) {
        return udx_btree_iter_first(iter);
    }
    struct btree_iter_stack_item *stack = &iter->stack[iter->nstack-1];
    stack->index++;
    if (stack->node->leaf) {
...
bool udx_btree_iter_prev(struct udx_btree_iter *iter) {
    if (!iter->seeked) {
        return false;
    }
    struct btree_iter_stack_item *stack = &iter->stack[iter->nstack-1];
...
bool udx_btree_iter_seek(struct udx_btree_iter *iter, const void *key) {
    iter->atend = false;
    iter->atstart = false;
    iter->seeked = false;
    iter->nstack = 0;
    ...
    while (1) {
        ...
        if (node->leaf) {
            iter->stack[iter->nstack-1].index--;
            return udx_btree_iter_next(iter);
        }
        node = node->children[i];
    }
}

const void *udx_btree_iter_item(struct udx_btree_iter *iter) {
    return iter->item;
}
